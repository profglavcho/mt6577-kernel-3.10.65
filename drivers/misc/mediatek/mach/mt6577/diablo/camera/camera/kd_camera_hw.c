...
u32 pinSet[3][8] = {
    ...
    /*By zhfan, for ov8850 truly sunny module compatible.
    **Gpio internal split-voltage will cause the voltage to be 0.9V,not 1.8V(DOVDD).
    **Disable gpio pull to prevent the instable status.*/
