...
#define DDS_DIV1_1000_FREQ		(0x00099D8A)	/* 1000MHz */
	...
	/*if (con1 >= DDS_DIV1_1000_FREQ) {
		freq = DDS_DIV1_1000_FREQ;
		freq = PLL_DIV1_1000_FREQ + (((con1 - freq) / 0x2000) * PLL_FREQ_STEP);
	}
	else
		BUG();*/
...
#define DDS_DIV1_1000_FREQ		(0x00099D8A)	/* 1000MHz */
	...
	/*if (khz >= PLL_DIV1_1000_FREQ)
		dds = DDS_DIV1_1000_FREQ + ((khz - PLL_DIV1_1000_FREQ) / PLL_FREQ_STEP) * 0x2000;
    else
		BUG();*/
	
	if (khz == PLL_DIV1_1000_FREQ)
		dds = DDS_DIV1_1000_FREQ;
