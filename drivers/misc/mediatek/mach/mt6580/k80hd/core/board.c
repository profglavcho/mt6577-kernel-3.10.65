...
#define MSDC_SDIO_FLAG    (MSDC_EXT_SDIO_IRQ | MSDC_HIGHSPEED | MSDC_UHS1)
    ...
    struct msdc_ett_settings msdc0_ett_settings[] = {
        ...
        { MSDC_HS200_MODE, 0xb0,  (0x1f<<10), 0x1 }, //PATCH_BIT0[MSDC_PB0_CKGEN_MSDC_DLY_SEL]
        ...
        { MSDC_HS200_MODE, 0xf0,  (0x1f<<16), 0x1d }, //PAD_TUNE[MSDC_PAD_TUNE_CMDRDLY]
        { MSDC_HS200_MODE, 0xf0,  (0x1f<<22), 0xc }, //PAD_TUNE[MSDC_PAD_TUNE_CMDRRDLY]

        /* write ett settings */
        { MSDC_HS200_MODE, 0xb4,  (0x7 << 0), 0x3 }, //PATCH_BIT1[MSDC_PB1_WRDAT_CRCS_TA_CNTR]
        { MSDC_HS200_MODE, 0xf0,  (0x1f<< 0), 0x6 }, //PAD_TUNE[MSDC_PAD_TUNE_DATWRDLY]
        { MSDC_HS200_MODE, 0x4,   (0x1 <<8),  0x0 }, //MSDC_IOCON[MSDC_IOCON_W_D_SMPL]
        { MSDC_HS200_MODE, 0xf8,  (0x1f<<24), 0x0 }, //DAT_RD_DLY0[MSDC_DAT_RDDLY0_D0]

        /* read ett settings */
        { MSDC_HS200_MODE, 0xf0,  (0x1f<< 8), 0x15}, //PAD_TUNE[MSDC_PAD_TUNE_DATRRDLY]
