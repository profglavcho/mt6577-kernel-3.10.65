...
{  
    ...
    wmt_tm_dprintk("%s Curr Tput %lu ratio %u limit_tput %lu",__func__,tx_throughput,limit_ratio,limit_tput);
                            ...
                            unsigned long *pv)
{
    ...
    int temp = 0;
    int temp_ts1 = 0, temp_ts2 = 0, temp_ts3 = 0;
    //int temp_ts4 = 0;
...
ssize_t wmt_wifi_in_soc_write(struct file *filp, const char __user *buf, size_t len, loff_t *data)
{
	...
	wmt_tm_printk("%s ret %d %d %d %d %d %d %d %d %d %d %d %d %d", __func__, ret, target_tj_source,wmt_wifi_target_tj,
