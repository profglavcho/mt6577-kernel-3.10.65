...
fm_s32 mt6580_pwrup_clock_on(fm_u8 *buf, fm_s32 buf_size)
{
	...
	/* deemphasis setting */
	pkt_size += fm_bop_modify(0x61, ~DE_EMPHASIS, (de_emphasis << 12), &buf[pkt_size], \
				  buf_size - pkt_size);
...
fm_s32 mt6580_pwrup_digital_init(fm_u8 *buf, fm_s32 buf_size)
{
	...
	pkt_size += fm_bop_write(0x6A, 0x0021, &buf[pkt_size], buf_size - pkt_size);	/* wr 6A 0021, set 1 to enable interrupt  */
 ...
 * return package size
 */
fm_s32 mt6580_seek(fm_u8 *buf, fm_s32 buf_size, fm_u16 seekdir, fm_u16 space, fm_u16 max_freq,
		   fm_u16 min_freq)
{
	fm_s32 pkt_size = 0;
 ...
 * return package size
 */
fm_s32 mt6580_scan(fm_u8 *buf, fm_s32 buf_size, fm_u16 scandir, fm_u16 space, fm_u16 max_freq,
		   fm_u16 min_freq)
{
	fm_s32 pkt_size = 0;
