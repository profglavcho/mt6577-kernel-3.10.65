...
//<2014/05/26-Yuting Shih. Modified/merged from JB.
#if 0 //defined( ARIMA_PROJECT_HAWK35 ) || defined( ARIMA_PROJECT_HAWK40 )
	mt_eint_set_sens(CUST_EINT_ACCDET_NUM, CUST_EINT_ACCDET_SENSITIVE);
#else
	//mt_eint_set_sens(CUST_EINT_ACCDET_NUM, CUST_EINT_ACCDET_SENSITIVE);
#endif
//>2014/05/26-Yuting Shih.

	mt_eint_set_hw_debounce(CUST_EINT_ACCDET_NUM, CUST_EINT_ACCDET_DEBOUNCE_CN);
//<2014/05/26-Yuting Shih. Modified/merged from JB for ACC_ANSWER_CALL.
#if 0 //defined( ARIMA_PROJECT_HAWK35 ) || defined( ARIMA_PROJECT_HAWK40 )
...
static inline void check_cable_type(void)
{
   ...
   // clear_accdet_interrupt();
    ...
    switch(accdet_status)
    {
        ...
        //<2014/05/26-Yuting Shih-[BU2SC00145662][BU2SC00145664][HAWK-11496]. It can be answer a call when ring tone.
        #if defined( ARIMA_PROJECT_HAWK35 ) || defined( ARIMA_PROJECT_HAWK40 )
            else
            {
                if( is_long_press())
        ...
        #endif  /* End.. (ARIMA_PROJECT_HAWK35)||... */
        //>2014/05/26-Yuting Shih-[BU2SC00145662][BU2SC00145664][HAWK-11496].
